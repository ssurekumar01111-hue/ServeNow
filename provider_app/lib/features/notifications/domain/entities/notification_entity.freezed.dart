...
mixin _$NotificationEntity {
 ...
 String get id; String get title; String get body; DateTime get createdAt; bool get isRead; Map<String, dynamic>? get data;
...
@override
int get hashCode => Object.hash(runtimeType,id,title,body,createdAt,isRead,const DeepCollectionEquality().hash(data));

@override
String toString() {
  return 'NotificationEntity(id: $id, title: $title, body: $body, createdAt: $createdAt, isRead: $isRead, data: $data)';
}
...
@useResult
$Res call({
 String id, String title, String body, DateTime createdAt, bool isRead, Map<String, dynamic>? data
});
...
/// Create a copy of NotificationEntity
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? title = null,Object? body = null,Object? createdAt = null,Object? isRead = null,Object? data = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String title,  String body,  DateTime createdAt,  bool isRead,  Map<String, dynamic>? data)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _NotificationEntity() when $default != null:
return $default(_that.id,_that.title,_that.body,_that.createdAt,_that.isRead,_that.data);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String title,  String body,  DateTime createdAt,  bool isRead,  Map<String, dynamic>? data)  $default,) {final _that = this;
switch (_that) {
case _NotificationEntity():
return $default(_that.id,_that.title,_that.body,_that.createdAt,_that.isRead,_that.data);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String title,  String body,  DateTime createdAt,  bool isRead,  Map<String, dynamic>? data)?  $default,) {final _that = this;
switch (_that) {
case _NotificationEntity() when $default != null:
return $default(_that.id,_that.title,_that.body,_that.createdAt,_that.isRead,_that.data);case _:
  return null;
...
class _NotificationEntity extends NotificationEntity {
  const _NotificationEntity({required this.id, required this.title, required this.body, required this.createdAt, required this.isRead, final  Map<String, dynamic>? data}): _data = data,super._();
...
@override
int get hashCode => Object.hash(runtimeType,id,title,body,createdAt,isRead,const DeepCollectionEquality().hash(_data));
...
/// Create a copy of NotificationEntity
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? title = null,Object? body = null,Object? createdAt = null,Object? isRead = null,Object? data = freezed,}) {

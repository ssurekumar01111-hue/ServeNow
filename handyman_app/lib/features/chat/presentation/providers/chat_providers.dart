...
import 'package:handyman/features/chat/data/datasources/chat_remote_datasource.dart';
import 'package:handyman/features/chat/data/repositories/chat_repository_impl.dart';
import 'package:handyman/features/chat/domain/entities/message_entity.dart';
import 'package:handyman/features/chat/domain/repositories/chat_repository.dart';
...
final StreamProviderFamily<List<MessageEntity>, String> messagesProvider = StreamProvider.family<List<MessageEntity>, String>((ref, bookingId) {

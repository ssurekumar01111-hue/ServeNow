...
mixin _$CategoryModel {
 ...
 String get id; String get name; String get iconUrl; int get sortOrder; bool get isActive; String? get iconName; String? get color;
...
@override
String toString() {
  return 'CategoryModel(id: $id, name: $name, iconUrl: $iconUrl, sortOrder: $sortOrder, isActive: $isActive, iconName: $iconName, color: $color)';
}
...
class _CategoryModel extends CategoryModel {
  const _CategoryModel({required this.id, required this.name, required this.iconUrl, required this.sortOrder, this.isActive = true, this.iconName, this.color}): super._();
